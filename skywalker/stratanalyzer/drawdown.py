...
from skywalker import stratanalyzer
...
class DrawDown(stratanalyzer.StrategyAnalyzer):
    ...
    def beforeOnBars(self, strat, bars):
        ...
        if self.__currDrawDown.getCurrentDrawDown() <= self.__maxDD:
            self.__maxDDDate = bars.getDateTime()
    ...
    def getMaxDrawDownDateTime(self):
        return self.__maxDDDate
