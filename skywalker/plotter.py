...
from skywalker import warninghelpers
...
class StrategyPlotter(object):
    ...
    def save(self, fromDateTime=None, toDateTime=None, postPlotFun=_post_plot_fun, figname="strategy execution.png"):
        """Saves the strategy execution."""
        fig, mplSubplots = self.__buildFigureImpl(fromDateTime, toDateTime, postPlotFun=postPlotFun)
        fig.autofmt_xdate()
        fig.savefig(figname)
