...
def create_returns_tear_sheet(returns, live_start_date=None,
                              ...
                              benchmark_rets=None,
                              bootstrap=False,
                              return_fig=False, save_fig=None):
    """
    ...
    drawdown_df = timeseries.gen_drawdown_table(returns, top=10)
...
def create_position_tear_sheet(returns, positions, gross_lev=None,
    ...
    _, df_top_long, df_top_short, df_top_abs = plotting.show_and_plot_top_positions(
        returns,
        positions_alloc,
...
def create_txn_tear_sheet(returns, positions, transactions,
                          unadjusted_returns=None, return_fig=False, save_fig=None):
    """
...
def create_round_trip_tear_sheet(returns, positions, transactions,
    ...
    stats = round_trips.print_round_trip_stats(trades)

    pct_profit_attribution = plotting.show_profit_attribution(trades)
    ...
    # if return_fig:
    #     return fig
    return stats, pct_profit_attribution
...
def create_bayesian_tear_sheet(returns, benchmark_rets=None,
                               ...
                               return_fig=False, stoch_vol=False, save_fig=None):
    """
